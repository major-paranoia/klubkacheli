...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_article_container_article_container_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/article-container/article-container.component */
    "./src/app/components/article-container/article-container.component.ts");
    /* harmony import */


    var _components_article_item_article_item_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/article-item/article-item.component */
    "./src/app/components/article-item/article-item.component.ts");
    /* harmony import */


    var _components_single_page_handler_single_page_handler_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/single-page-handler/single-page-handler.component */
    "./src/app/components/single-page-handler/single-page-handler.component.ts");

    var routes = [{
      path: '',
      component: _components_article_container_article_container_component__WEBPACK_IMPORTED_MODULE_2__["ArticleContainerComponent"]
    }, {
      path: 'article/:_id',
      component: _components_article_item_article_item_component__WEBPACK_IMPORTED_MODULE_3__["ArticleItemComponent"]
    }, {
      path: 'category/:categoryId',
      component: _components_article_container_article_container_component__WEBPACK_IMPORTED_MODULE_2__["ArticleContainerComponent"]
    }, {
      path: 'info/:singlePageId',
      component: _components_single_page_handler_single_page_handler_component__WEBPACK_IMPORTED_MODULE_4__["SinglePageHandlerComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_container_container_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _components_south_bar_south_bar_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/south-bar/south-bar.component */
    "./src/app/components/south-bar/south-bar.component.ts");
    /* harmony import */


    var _components_social_media_link_social_media_link_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/social-media-link/social-media-link.component */
    "./src/app/components/social-media-link/social-media-link.component.ts");
    /* harmony import */


    var _components_social_media_link_item_social_media_link_item_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/social-media-link-item/social-media-link-item.component */
    "./src/app/components/social-media-link-item/social-media-link-item.component.ts");
    /* harmony import */


    var _components_other_categories_other_categories_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/other-categories/other-categories.component */
    "./src/app/components/other-categories/other-categories.component.ts");
    /* harmony import */


    var _components_other_categories_item_other_categories_item_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/other-categories-item/other-categories-item.component */
    "./src/app/components/other-categories-item/other-categories-item.component.ts");
    /* harmony import */


    var _components_category_container_category_container_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/category-container/category-container.component */
    "./src/app/components/category-container/category-container.component.ts");
    /* harmony import */


    var _components_article_preview_item_article_preview_item_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/article-preview-item/article-preview-item.component */
    "./src/app/components/article-preview-item/article-preview-item.component.ts");
    /* harmony import */


    var _components_article_item_article_item_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./components/article-item/article-item.component */
    "./src/app/components/article-item/article-item.component.ts");
    /* harmony import */


    var _components_contacts_container_contacts_container_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./components/contacts-container/contacts-container.component */
    "./src/app/components/contacts-container/contacts-container.component.ts");
    /* harmony import */


    var _components_article_container_article_container_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./components/article-container/article-container.component */
    "./src/app/components/article-container/article-container.component.ts");
    /* harmony import */


    var _components_style_switch_item_style_switch_item_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./components/style-switch-item/style-switch-item.component */
    "./src/app/components/style-switch-item/style-switch-item.component.ts");
    /* harmony import */


    var _components_other_categories_container_other_categories_container_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./components/other-categories-container/other-categories-container.component */
    "./src/app/components/other-categories-container/other-categories-container.component.ts");
    /* harmony import */


    var _components_articles_articles_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    ...
    var _main_nav_main_nav_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    ...
    var _articles_table_articles_table_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    /*! ./articles-table/articles-table.component */
    ...
    var _components_podcast_preview_item_podcast_preview_item_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! ./components/podcast-preview-item/podcast-preview-item.component */
    "./src/app/components/podcast-preview-item/podcast-preview-item.component.ts");
    /* harmony import */


    var _components_single_page_handler_single_page_handler_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! ./components/single-page-handler/single-page-handler.component */
    "./src/app/components/single-page-handler/single-page-handler.component.ts");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_24__["BrowserAnimationsModule"], _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_26__["LayoutModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_27__["MatToolbarModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_28__["MatButtonModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_29__["MatSidenavModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_31__["MatListModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_32__["MatPaginatorModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_34__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_35__["MatSortModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_articles_articles_component__WEBPACK_IMPORTED_MODULE_23__["ArticlesComponent"], _components_categories_categories_component__WEBPACK_IMPORTED_MODULE_5__["CategoriesComponent"], _components_category_item_category_item_component__WEBPACK_IMPORTED_MODULE_6__["CategoryItemComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_7__["HeaderComponent"], _components_container_container_component__WEBPACK_IMPORTED_MODULE_8__["ContainerComponent"], _components_article_preview_article_preview_component__WEBPACK_IMPORTED_MODULE_9__["ArticlePreviewComponent"], _components_contacts_contacts_component__WEBPACK_IMPORTED_MODULE_10__["ContactsComponent"], _components_south_bar_south_bar_component__WEBPACK_IMPORTED_MODULE_11__["SouthBarComponent"], _components_social_media_link_social_media_link_component__WEBPACK_IMPORTED_MODULE_12__["SocialMediaLinkComponent"], _components_social_media_link_item_social_media_link_item_component__WEBPACK_IMPORTED_MODULE_13__["SocialMediaLinkItemComponent"], _components_other_categories_other_categories_component__WEBPACK_IMPORTED_MODULE_14__["OtherCategoriesComponent"], _components_other_categories_item_other_categories_item_component__WEBPACK_IMPORTED_MODULE_15__["OtherCategoriesItemComponent"], _components_category_container_category_container_component__WEBPACK_IMPORTED_MODULE_16__["CategoryContainerComponent"], _components_article_preview_item_article_preview_item_component__WEBPACK_IMPORTED_MODULE_17__["ArticlePreviewItemComponent"], _components_article_item_article_item_component__WEBPACK_IMPORTED_MODULE_18__["ArticleItemComponent"], _components_contacts_container_contacts_container_component__WEBPACK_IMPORTED_MODULE_19__["ContactsContainerComponent"], _components_article_container_article_container_component__WEBPACK_IMPORTED_MODULE_20__["ArticleContainerComponent"], _components_style_switch_item_style_switch_item_component__WEBPACK_IMPORTED_MODULE_21__["StyleSwitchItemComponent"], _components_other_categories_container_other_categories_container_component__WEBPACK_IMPORTED_MODULE_22__["OtherCategoriesContainerComponent"], _main_nav_main_nav_component__WEBPACK_IMPORTED_MODULE_25__["MainNavComponent"], _articles_table_articles_table_component__WEBPACK_IMPORTED_MODULE_33__["ArticlesTableComponent"], _components_podcast_preview_item_podcast_preview_item_component__WEBPACK_IMPORTED_MODULE_36__["PodcastPreviewItemComponent"], _components_single_page_handler_single_page_handler_component__WEBPACK_IMPORTED_MODULE_37__["SinglePageHandlerComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_24__["BrowserAnimationsModule"], _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_26__["LayoutModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_27__["MatToolbarModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_28__["MatButtonModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_29__["MatSidenavModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_30__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_31__["MatListModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_32__["MatPaginatorModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_34__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_35__["MatSortModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppArticlesTableArticlesTableDatasourceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArticlesTableDataSource", function () {
      return ArticlesTableDataSource;
    });
    /* harmony import */
    ...
    var ArticlesTableDataSource =
    /*#__PURE__*/
    function (_angular_cdk_collecti) {
      _inherits(ArticlesTableDataSource, _angular_cdk_collecti);

      function ArticlesTableDataSource() {
        var _this;

        _classCallCheck(this, ArticlesTableDataSource);

        _this = _possibleConstructorReturn(this, _getPrototypeOf(ArticlesTableDataSource).call(this));
      ...
      _createClass(ArticlesTableDataSource, [{
        key: "connect",
  ...
  /***/
  function srcAppArticlesTableArticlesTableComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArticlesTableComponent", function () {
    ...
    var _articles_table_datasource__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./articles-table-datasource */
    "./src/app/articles-table/articles-table-datasource.ts");

    function ArticlesTableComponent_th_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ArticlesTableComponent_td_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ArticlesTableComponent_th_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 10);
    ...
    function ArticlesTableComponent_td_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 11);
    ...
    function ArticlesTableComponent_tr_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 12);
      }
    }

    function ArticlesTableComponent_tr_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ArticlesTableComponent =
    /*#__PURE__*/
    function () {
      function ArticlesTableComponent() {
        _classCallCheck(this, ArticlesTableComponent);

        /** Columns displayed in the table. Columns IDs can be added, removed, or reordered. */
        this.displayedColumns = ['id', 'name'];
      }

      _createClass(ArticlesTableComponent, [{
        key: "ngOnInit",
    ...
    ArticlesTableComponent.ɵfac = function ArticlesTableComponent_Factory(t) {
      return new (t || ArticlesTableComponent)();
    };

    ArticlesTableComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ArticlesTableComponent,
      selectors: [["app-articles-table"]],
      viewQuery: function ArticlesTableComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function ArticlesTableComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticlesTableComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsArticleContainerArticleContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArticleContainerComponent", function () {
    ...
    var _article_preview_article_preview_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var ArticleContainerComponent =
    /*#__PURE__*/
    function () {
      function ArticleContainerComponent(route, router, categoryService) {
        _classCallCheck(this, ArticleContainerComponent);
      ...
      _createClass(ArticleContainerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this4 = this;

          this.sub = this.route.params.subscribe(function (params) {
            _this4.router.routeReuseStrategy.shouldReuseRoute = function () {
              return false;
            };
            ...
            _this4.categoryService.getCategories().subscribe(function (categories) {
              ...
              if (_article_preview_article_preview_component__WEBPACK_IMPORTED_MODULE_1__["ArticlePreviewComponent"].selectedCategory === undefined || _article_preview_article_preview_component__WEBPACK_IMPORTED_MODULE_1__["ArticlePreviewComponent"].selectedCategory === '' || _article_preview_article_preview_component__WEBPACK_IMPORTED_MODULE_1__["ArticlePreviewComponent"].selectedCategory === 'home') {
                _this4.categoryTitle = _this4.getRussianTitleOfCategory('home');
              } else _this4.categoryTitle = _this4.getRussianTitleOfCategory(_article_preview_article_preview_component__WEBPACK_IMPORTED_MODULE_1__["ArticlePreviewComponent"].selectedCategory);
            });
          });
        }
      }, {
        ...
        key: "getRussianTitleOfCategory",
        value: function getRussianTitleOfCategory(categoryId) {
    ...
    ArticleContainerComponent.ɵfac = function ArticleContainerComponent_Factory(t) {
      return new (t || ArticleContainerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_category_service__WEBPACK_IMPORTED_MODULE_3__["CategoryService"]));
    };

    ArticleContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ArticleContainerComponent,
      selectors: [["app-article-container"]],
      decls: 6,
      vars: 1,
      consts: [["id", "heading"], ["id", "previews"]],
      template: function ArticleContainerComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
  ...
  /***/
  function srcAppComponentsArticleItemArticleItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _articles_articles_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    function ArticleItemComponent_div_4_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ArticleItemComponent_div_4_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ArticleItemComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    /*#__PURE__*/
    function () {
      function ArticleItemComponent(route, router, sanitizer) {
      ...
      _createClass(ArticleItemComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this.route.params.subscribe(function (params) {
            ...
            _this5.articleId = params['_id'];
          });

          _articles_articles_component__WEBPACK_IMPORTED_MODULE_1__["ArticlesComponent"].articles.forEach(function (article) {
            if (article._id === _this5.articleId) {
              _this5.article = article;
            }
          });
          ...
          if (this.article !== undefined) {
            ...
            if (this.article.content.includes("iframe")) {
              ...
              this.splitedArticleContent.forEach(function (element) {
                if (element.includes('https://www.youtube.com/embed/')) {
                  _this5.allContents.push(_this5.getEmbedUrl(element.split('https://www.youtube.com/embed/')[1].split("'")[0].split("\"")[0], 'youtube'));
                } else if (element.includes('https://vk.com/video_ext.php')) {
                  _this5.allContents.push(_this5.getEmbedUrl(element.split('https://vk.com/video_ext.php')[1].split("'")[0].split("\"")[0], 'vk'));
                } else _this5.allContents.push(element);

                if (element.includes("</iframe>")) {
                  _this5.allContents.push(element.split("</iframe>")[1]);
                }
              });
        ...
        key: "getEmbedUrl",
        value: function getEmbedUrl(url, type) {
          var fullUrl;
          if (type === 'youtube') fullUrl = "https://www.youtube.com/embed/".concat(url);else if (type === 'vk') fullUrl = "https://vk.com/video_ext.php".concat(url);
          return this.sanitizer.bypassSecurityTrustResourceUrl(fullUrl);
        }
      }, {
        key: "checkIfElementIsResourceUrl",
        value: function checkIfElementIsResourceUrl(element) {
    ...
    ArticleItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 3,
      consts: [["width", "100%", 3, "src"], ["id", "header"], [4, "ngFor", "ngForOf"], [3, "innerHTML", 4, "ngIf"], ["class", "videoContainer", 4, "ngIf"], [3, "innerHTML"], [1, "videoContainer"], ["width", "100%", "height", "600", "frameborder", "0", "allow", "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture", "allowfullscreen", "", 1, "videoItem", 3, "src"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticleItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsArticlePreviewItemArticlePreviewItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArticlePreviewItemComponent", function () {
      return ArticlePreviewItemComponent;
    });
    /* harmony import */
    ...
    var ArticlePreviewItemComponent =
    /*#__PURE__*/
    function () {
      function ArticlePreviewItemComponent() {
        _classCallCheck(this, ArticlePreviewItemComponent);
      }

      _createClass(ArticlePreviewItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "onClick",
    ...
    ArticlePreviewItemComponent.ɵfac = function ArticlePreviewItemComponent_Factory(t) {
      return new (t || ArticlePreviewItemComponent)();
    };

    ArticlePreviewItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ArticlePreviewItemComponent,
      selectors: [["app-article-preview-item"]],
      inputs: {
        articlePreview: "articlePreview"
      },
      decls: 7,
      vars: 6,
      consts: [["id", "articlePreviewItem", 3, "routerLink", "click"], ["id", "imgContainer"], [3, "src"]],
      template: function ArticlePreviewItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ArticlePreviewItemComponent_Template_button_click_0_listener($event) {
            return ctx.onClick(ctx.articlePreview._id);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticlePreviewItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppComponentsArticlePreviewArticlePreviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _article_preview_item_article_preview_item_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../article-preview-item/article-preview-item.component */
    "./src/app/components/article-preview-item/article-preview-item.component.ts");
    /* harmony import */


    var _podcast_preview_item_podcast_preview_item_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../podcast-preview-item/podcast-preview-item.component */
    "./src/app/components/podcast-preview-item/podcast-preview-item.component.ts");

    function ArticlePreviewComponent_div_0_app_article_preview_item_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-article-preview-item", 6);
      }

      if (rf & 2) {
        var articlePreview_r6 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("articlePreview", articlePreview_r6);
      }
    }

    function ArticlePreviewComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ArticlePreviewComponent_div_1_app_podcast_preview_item_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-podcast-preview-item", 8);
      }

      if (rf & 2) {
        var podcastPreview_r8 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("podcastPreview", podcastPreview_r8);
      }
    }

    function ArticlePreviewComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 4);
    ...
    function ArticlePreviewComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var ArticlePreviewComponent =
    /*#__PURE__*/
    function () {
      function ArticlePreviewComponent(articlesComponent, matPaginatorIntl) {
      ...
      _createClass(ArticlePreviewComponent, [{
        ...
        key: "nextPage",
        value: function nextPage(startPoint) {
          try {
            if (ArticlePreviewComponent.selectedCategory !== undefined && ArticlePreviewComponent.selectedCategory !== '' && ArticlePreviewComponent.selectedCategory !== 'home') {
              if (ArticlePreviewComponent.selectedCategory === 'podcasts') {
        ...
        key: "getRussianRangeLabel",
        value: function getRussianRangeLabel(page, pageSize, length) {
    ...
    ArticlePreviewComponent.ɵfac = function ArticlePreviewComponent_Factory(t) {
      return new (t || ArticlePreviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_articles_articles_component__WEBPACK_IMPORTED_MODULE_1__["ArticlesComponent"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_paginator__WEBPACK_IMPORTED_MODULE_2__["MatPaginatorIntl"]));
    };
    ...
    ArticlePreviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 6,
      consts: [["class", "itemContainer", 4, "ngIf"], ["color", "accent", 3, "length", "pageIndex", "pageSize", "page"], ["paginator", ""], [4, "ngIf"], [1, "itemContainer"], ["class", "previewItem", 3, "articlePreview", 4, "ngFor", "ngForOf"], [1, "previewItem", 3, "articlePreview"], ["class", "previewItem", 3, "podcastPreview", 4, "ngFor", "ngForOf"], [1, "previewItem", 3, "podcastPreview"]],
      template: function ArticlePreviewComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("page", function ArticlePreviewComponent_Template_mat_paginator_page_2_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArticlePreviewComponent, [{
        ...
        return [{
          type: _articles_articles_component__WEBPACK_IMPORTED_MODULE_1__["ArticlesComponent"]
        }, {
  ...
  function srcAppComponentsArticlesArticlesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_articlePreview__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../models/articlePreview */
    ...
    /*#__PURE__*/
    function () {
      function ArticlesComponent(articleService, appComponent) {
      ...
      _createClass(ArticlesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.articleService.getArticles().subscribe(function (articles) {
            ...
            if (ArticlesComponent.articles !== undefined) {
              _this6.appComponent.articlesLoaded = Promise.resolve(true);
            }
          });
        }
      }, {
        key: "getPreviews",
        value: function getPreviews(startIndex, amount) {
          var articlePreviews;
          if (ArticlesComponent.getArticlesAmount() - startIndex >= amount) articlePreviews = new Array(amount);else articlePreviews = new Array(ArticlesComponent.getArticlesAmount() - startIndex);
        ...
        key: "getPreviewsById",
        value: function getPreviewsById(id, startIndex, amount) {
          var articlePreviews;
          ArticlesComponent.articlesById = new Array();
          ArticlesComponent.articlesById = ArticlesComponent.getArticleswithSelectedId(id);
          if (ArticlesComponent.articlesById.length - startIndex >= amount) articlePreviews = new Array(amount);else articlePreviews = new Array(ArticlesComponent.articlesById.length - startIndex);
        ...
        key: "getPodcastPreviewsById",
        value: function getPodcastPreviewsById(id, startIndex, amount) {
          var podcastPreviews;
          ArticlesComponent.articlesById = new Array();
          ArticlesComponent.articlesById = ArticlesComponent.getArticleswithSelectedId(id);
          if (ArticlesComponent.articlesById.length - startIndex >= amount) podcastPreviews = new Array(amount);else podcastPreviews = new Array(ArticlesComponent.articlesById.length - startIndex);

          for (var i = 0; i < podcastPreviews.length; ++i) {
            if (startIndex == ArticlesComponent.articlesById.length) {
              break;
            }
        ...
        key: "getArticleswithSelectedId",
        value: function getArticleswithSelectedId(categoryId) {
          var articlesWithSelectedId = new Array();
          ArticlesComponent.articles.forEach(function (element) {
        ...
        key: "getArticlesByIdAmount",
        value: function getArticlesByIdAmount(categoryId) {
          var count = 0;

          for (var i = 0; i < ArticlesComponent.articles.length; ++i) {
        ...
        key: "getSinglePageArticles",
        value: function getSinglePageArticles() {
          var count = 0;
        ...
        key: "getArticlesAmount",
        value: function getArticlesAmount() {
    ...
    ArticlesComponent.ɵfac = function ArticlesComponent_Factory(t) {
      return new (t || ArticlesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_article_service__WEBPACK_IMPORTED_MODULE_2__["ArticleService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]));
    };
  ...
  function srcAppComponentsCategoriesCategoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_category__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../models/category */
    ...
    function CategoriesComponent_app_category_item_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function CategoriesComponent(categoryService, router) {
      ...
      _createClass(CategoriesComponent, [{
        ...
        value: function OnRouteChange() {
          ...
          if (splitedUrl[splitedUrl.length - 2] === 'category' || splitedUrl[splitedUrl.length - 2] === 'info') {
            var categoryId = splitedUrl[splitedUrl.length - 1];
        ...
        value: function ngOnInit() {
          ...
          this.categoryService.getCategories().subscribe(function (categories) {
            ...
            CategoriesComponent.statCategories = new Array(_this7.categories.length);
            _this7.categoriesSelection = new Array(_this7.categories.length);

            for (var i = 0; i < _this7.categoriesSelection.length; ++i) {
              _this7.categoriesSelection[i] = false;
              CategoriesComponent.statCategories[i] = new _models_category__WEBPACK_IMPORTED_MODULE_1__["Category"]();
              CategoriesComponent.statCategories[i].title = _this7.categories[i].title;
              CategoriesComponent.statCategories[i].categoryId = _this7.categories[i].categoryId;
            }
        ...
        key: "selectItem",
        value: function selectItem(categoryId) {
          var position = this.getCategoriesPostion(categoryId);

          if (!this.isSelected(categoryId)) {
            for (var i = 0; i < this.categoriesSelection.length; ++i) {
        ...
        key: "isSelected",
        value: function isSelected(categoryId) {
          return this.categoriesSelection[this.getCategoriesPostion(categoryId)];
        }
      }, {
        key: "getCategoriesPostion",
        value: function getCategoriesPostion(categoryId) {
          for (var i = 0; i < this.categories.length; ++i) {
            if (this.categories[i].categoryId === categoryId) {
              return i;
            }
    ...
    CategoriesComponent.ɵfac = function CategoriesComponent_Factory(t) {
      return new (t || CategoriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_category_service__WEBPACK_IMPORTED_MODULE_2__["CategoryService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };
    ...
    CategoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[3, "category", 4, "ngFor", "ngForOf"], [3, "category"]],
  ...
  /***/
  function srcAppComponentsCategoryContainerCategoryContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CategoryContainerComponent", function () {
    ...
    var CategoryContainerComponent =
    /*#__PURE__*/
    function () {
      function CategoryContainerComponent() {
        _classCallCheck(this, CategoryContainerComponent);
      }

      _createClass(CategoryContainerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    CategoryContainerComponent.ɵfac = function CategoryContainerComponent_Factory(t) {
      return new (t || CategoryContainerComponent)();
    };

    CategoryContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CategoryContainerComponent,
      selectors: [["app-category-container"]],
      decls: 2,
      vars: 0,
      consts: [["id", "categoryContainer"]],
      template: function CategoryContainerComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
  ...
  function srcAppComponentsCategoryItemCategoryItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CategoryItemComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoryItemComponent_div_0_Template_input_click_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20);

          var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r19.onClick(ctx_r19.category);
        });
    ...
    function CategoryItemComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoryItemComponent_div_1_Template_input_click_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r22);

          var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r21.onClick(ctx_r21.category);
        });
    ...
    /*#__PURE__*/
    function () {
      function CategoryItemComponent(categoriesComponent) {
      ...
      _createClass(CategoryItemComponent, [{
        ...
        key: "onClick",
        value: function onClick(category) {
    ...
    CategoryItemComponent.ɵfac = function CategoryItemComponent_Factory(t) {
      return new (t || CategoryItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_categories_categories_component__WEBPACK_IMPORTED_MODULE_1__["CategoriesComponent"]));
    };
    ...
    CategoryItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 2,
      consts: [[4, "ngIf"], ["type", "button", 1, "categoryButton", 3, "ngClass", "value", "routerLink", "click"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgClass"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLink"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CategoryItemComponent, [{
        ...
        return [{
          type: _categories_categories_component__WEBPACK_IMPORTED_MODULE_1__["CategoriesComponent"]
        }];
      }, {
        category: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  /***/
  function srcAppComponentsContactsContainerContactsContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ContactsContainerComponent", function () {
    ...
    var _social_media_link_social_media_link_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../social-media-link/social-media-link.component */
    "./src/app/components/social-media-link/social-media-link.component.ts");

    var ContactsContainerComponent =
    /*#__PURE__*/
    function () {
      function ContactsContainerComponent() {
        _classCallCheck(this, ContactsContainerComponent);
      }

      _createClass(ContactsContainerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ContactsContainerComponent.ɵfac = function ContactsContainerComponent_Factory(t) {
      return new (t || ContactsContainerComponent)();
    };

    ContactsContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ContactsContainerComponent,
      selectors: [["app-contacts-container"]],
      decls: 3,
      vars: 0,
      consts: [["id", "contactContainer"]],
      template: function ContactsContainerComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    ContactsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ContactsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, " \u0412\u0441\u0435 \u043F\u0440\u0430\u0432\u0430 \u043D\u0430 \u0442\u0435\u043A\u0441\u0442\u0430 \u0438 \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F \u043F\u0440\u0438\u043D\u0430\u0434\u043B\u0435\u0436\u0430\u0442 \u0438\u0445 \u0430\u0432\u0442\u043E\u0440\u0430\u043C. \u041C\u0430\u0442\u0435\u0440\u0438\u0430\u043B\u044B \u0441\u0430\u0439\u0442\u044B \u043D\u0435 \u043C\u043E\u0433\u0443\u0442 \u0431\u044B\u0442\u044C \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u043D\u044B \u0432 \u043A\u043E\u043C\u043C\u0435\u0440\u0447\u0435\u0441\u043A\u0438\u0445 \u0446\u0435\u043B\u044F\u0445 \u0438 \u0431\u0435\u0437 \u0443\u043A\u0430\u0437\u0430\u043D\u0438\u044F \u043F\u0440\u044F\u043C\u043E\u0439 \u0441\u0441\u044B\u043B\u043A\u0438 \u043D\u0430 \u0440\u0435\u0441\u0443\u0440\u0441. \xA9 \u041A\u043B\u0443\u0431 \u041A\u0430\u0447\u0435\u043B\u0438 2020 ");
  ...
  function srcAppComponentsContainerContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ContainerComponent, [{
        ...
        key: "switchStyle",
        value: function switchStyle(styleStr) {
          if (styleStr === 'dark') {
    ...
    ContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [["id", "articleContainer", 3, "ngClass"]],
  ...
  function srcAppComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 0,
      consts: [["id", "headerContainer"], ["id", "mainHeader"]],
  ...
  /***/
  function srcAppComponentsOtherCategoriesContainerOtherCategoriesContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OtherCategoriesContainerComponent", function () {
      return OtherCategoriesContainerComponent;
    });
    /* harmony import */
    ...
    var _other_categories_other_categories_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../other-categories/other-categories.component */
    "./src/app/components/other-categories/other-categories.component.ts");

    var OtherCategoriesContainerComponent =
    /*#__PURE__*/
    function () {
      function OtherCategoriesContainerComponent() {
        _classCallCheck(this, OtherCategoriesContainerComponent);
      }

      _createClass(OtherCategoriesContainerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    OtherCategoriesContainerComponent.ɵfac = function OtherCategoriesContainerComponent_Factory(t) {
      return new (t || OtherCategoriesContainerComponent)();
    };

    OtherCategoriesContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: OtherCategoriesContainerComponent,
      selectors: [["app-other-categories-container"]],
      decls: 2,
      vars: 0,
      consts: [["id", "containerJournal"]],
      template: function OtherCategoriesContainerComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
  ...
  /***/
  function srcAppComponentsOtherCategoriesItemOtherCategoriesItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OtherCategoriesItemComponent", function () {
      return OtherCategoriesItemComponent;
    });
    /* harmony import */
    ...
    var OtherCategoriesItemComponent =
    /*#__PURE__*/
    function () {
      function OtherCategoriesItemComponent(otherCategoriesComponent) {
        _classCallCheck(this, OtherCategoriesItemComponent);

        this.otherCategoriesComponent = otherCategoriesComponent;
      }

      _createClass(OtherCategoriesItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    OtherCategoriesItemComponent.ɵfac = function OtherCategoriesItemComponent_Factory(t) {
      return new (t || OtherCategoriesItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_other_categories_other_categories_component__WEBPACK_IMPORTED_MODULE_1__["OtherCategoriesComponent"]));
    };

    OtherCategoriesItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: OtherCategoriesItemComponent,
      selectors: [["app-other-categories-item"]],
      inputs: {
        category: "category"
      },
      decls: 3,
      vars: 4,
      consts: [["type", "button", 1, "categoryButton", 3, "value", "routerLink"]],
      template: function OtherCategoriesItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OtherCategoriesItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _other_categories_other_categories_component__WEBPACK_IMPORTED_MODULE_1__["OtherCategoriesComponent"]
        }];
      }, {
        category: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  /***/
  function srcAppComponentsOtherCategoriesOtherCategoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OtherCategoriesComponent", function () {
      return OtherCategoriesComponent;
    });
    /* harmony import */
    ...
    var _models_otherCategory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../models/otherCategory */
    "./src/app/models/otherCategory.ts");
    /* harmony import */


    var _services_other_categories_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../services/other-categories.service */
    "./src/app/services/other-categories.service.ts");

    function OtherCategoriesComponent_app_other_categories_item_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var OtherCategoriesComponent =
    /*#__PURE__*/
    function () {
      function OtherCategoriesComponent(otherCategoriesService) {
        _classCallCheck(this, OtherCategoriesComponent);

        this.otherCategoriesService = otherCategoriesService;
      }

      _createClass(OtherCategoriesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this8 = this;

          this.otherCategoriesService.getCategories().subscribe(function (articles) {
            _this8.articles = articles;
            _this8.categories = new Array();

            for (var i = 0; i < 5; ++i) {
              _this8.categories[i] = new _models_otherCategory__WEBPACK_IMPORTED_MODULE_1__["OtherCategory"]();
              _this8.categories[i]._id = _this8.articles[_this8.articles.length - 1 - i]._id;
              _this8.categories[i].title = _this8.articles[_this8.articles.length - 1 - i].title;
            }
          });
        }
      }]);
    ...
    OtherCategoriesComponent.ɵfac = function OtherCategoriesComponent_Factory(t) {
      return new (t || OtherCategoriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_other_categories_service__WEBPACK_IMPORTED_MODULE_2__["OtherCategoriesService"]));
    };

    OtherCategoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: OtherCategoriesComponent,
      selectors: [["app-other-categories"]],
      decls: 1,
      vars: 1,
      consts: [[3, "category", 4, "ngFor", "ngForOf"], [3, "category"]],
      template: function OtherCategoriesComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OtherCategoriesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _services_other_categories_service__WEBPACK_IMPORTED_MODULE_2__["OtherCategoriesService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppComponentsPodcastPreviewItemPodcastPreviewItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PodcastPreviewItemComponent", function () {
      return PodcastPreviewItemComponent;
    });
    /* harmony import */
    ...
    var PodcastPreviewItemComponent =
    /*#__PURE__*/
    function () {
      function PodcastPreviewItemComponent(sanitizer) {
        _classCallCheck(this, PodcastPreviewItemComponent);

        this.sanitizer = sanitizer;
      }

      _createClass(PodcastPreviewItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        key: "getEmbedUrl",
        value: function getEmbedUrl(podcastPreview) {
    ...
    PodcastPreviewItemComponent.ɵfac = function PodcastPreviewItemComponent_Factory(t) {
      return new (t || PodcastPreviewItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["DomSanitizer"]));
    };

    PodcastPreviewItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: PodcastPreviewItemComponent,
      selectors: [["app-podcast-preview-item"]],
      inputs: {
        podcastPreview: "podcastPreview"
      },
      decls: 7,
      vars: 3,
      consts: [[1, "podcastPreviewItem"], [1, "videoContainer"], ["frameborder", "0", "allow", "accelerometer; encrypted-media; gyroscope; picture-in-picture", "allowfullscreen", "allowfullscreen", "mozallowfullscreen", "mozallowfullscreen", "msallowfullscreen", "msallowfullscreen", "oallowfullscreen", "oallowfullscreen", "webkitallowfullscreen", "webkitallowfullscreen", 1, "videoItem", 3, "src"]],
      template: function PodcastPreviewItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PodcastPreviewItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsSinglePageHandlerSinglePageHandlerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SinglePageHandlerComponent", function () {
      return SinglePageHandlerComponent;
    });
    /* harmony import */
    ...
    var SinglePageHandlerComponent =
    /*#__PURE__*/
    function () {
      function SinglePageHandlerComponent(route, router, categoryService) {
        _classCallCheck(this, SinglePageHandlerComponent);
      ...
      _createClass(SinglePageHandlerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this9 = this;

          this.sub = this.route.params.subscribe(function (params) {
            _this9.router.routeReuseStrategy.shouldReuseRoute = function () {
              return false;
            };

            _this9.singleArticleCategoryId = params['singlePageId'];

            _this9.categoryService.getCategories().subscribe(function (categories) {
              _this9.categories = categories;

              if (params['singlePageId'] === undefined || params['singlePageId'] === '' || params['singlePageId'] === 'home') {
                _this9.selectedPage = _this9.getRussianTitleOfCategory('home');
              } else _this9.selectedPage = _this9.getRussianTitleOfCategory(params['singlePageId']);
            });
          });

          _articles_articles_component__WEBPACK_IMPORTED_MODULE_1__["ArticlesComponent"].articles.forEach(function (article) {
            if (article.categoriesId === _this9.singleArticleCategoryId) {
              _this9.article = article;
            }
          });
        }
      }, {
    ...
    SinglePageHandlerComponent.ɵfac = function SinglePageHandlerComponent_Factory(t) {
      return new (t || SinglePageHandlerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_category_service__WEBPACK_IMPORTED_MODULE_3__["CategoryService"]));
    };

    SinglePageHandlerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SinglePageHandlerComponent,
      selectors: [["app-single-page-handler"]],
      decls: 9,
      vars: 4,
      consts: [["id", "heading"], ["id", "articleSelf"], ["width", "100%", 3, "src"], ["id", "header"], [3, "innerHTML"]],
      template: function SinglePageHandlerComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SinglePageHandlerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsSocialMediaLinkItemSocialMediaLinkItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SocialMediaLinkItemComponent", function () {
      return SocialMediaLinkItemComponent;
    });
    /* harmony import */
    ...
    var SocialMediaLinkItemComponent =
    /*#__PURE__*/
    function () {
      function SocialMediaLinkItemComponent() {
        _classCallCheck(this, SocialMediaLinkItemComponent);
      }

      _createClass(SocialMediaLinkItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    SocialMediaLinkItemComponent.ɵfac = function SocialMediaLinkItemComponent_Factory(t) {
      return new (t || SocialMediaLinkItemComponent)();
    };

    SocialMediaLinkItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SocialMediaLinkItemComponent,
      selectors: [["app-social-media-link-item"]],
      decls: 2,
      vars: 0,
      template: function SocialMediaLinkItemComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SocialMediaLinkItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsSocialMediaLinkSocialMediaLinkComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SocialMediaLinkComponent", function () {
    ...
    var SocialMediaLinkComponent =
    /*#__PURE__*/
    function () {
      function SocialMediaLinkComponent() {
        _classCallCheck(this, SocialMediaLinkComponent);
      }

      _createClass(SocialMediaLinkComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SocialMediaLinkComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsSouthBarSouthBarComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SouthBarComponent", function () {
      return SouthBarComponent;
    });
    /* harmony import */
    ...
    var _c0 = function _c0() {
      return ["/info/CopyrightHolder"];
    };

    var _c1 = function _c1() {
      return ["/info/Advertiser"];
    };
    ...
    var SouthBarComponent =
    /*#__PURE__*/
    function () {
      function SouthBarComponent() {
        _classCallCheck(this, SouthBarComponent);
      }

      _createClass(SouthBarComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "onClick",
        value: function onClick(styleStr) {
    ...
    SouthBarComponent.ɵfac = function SouthBarComponent_Factory(t) {
      return new (t || SouthBarComponent)();
    };

    SouthBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SouthBarComponent,
      selectors: [["app-south-bar"]],
      decls: 19,
      vars: 8,
      consts: [["id", "containerSouthBar"], [3, "routerLink"]],
      template: function SouthBarComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SouthBarComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsStyleSwitchItemStyleSwitchItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StyleSwitchItemComponent", function () {
      return StyleSwitchItemComponent;
    });
    /* harmony import */
    ...
    var StyleSwitchItemComponent =
    /*#__PURE__*/
    function () {
      function StyleSwitchItemComponent() {
        _classCallCheck(this, StyleSwitchItemComponent);
      }

      _createClass(StyleSwitchItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    StyleSwitchItemComponent.ɵfac = function StyleSwitchItemComponent_Factory(t) {
      return new (t || StyleSwitchItemComponent)();
    };

    StyleSwitchItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: StyleSwitchItemComponent,
      selectors: [["app-style-switch-item"]],
      decls: 2,
      vars: 0,
      template: function StyleSwitchItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StyleSwitchItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppMainNavMainNavComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_category_container_category_container_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../components/category-container/category-container.component */
    "./src/app/components/category-container/category-container.component.ts");
    /* harmony import */


    var _components_other_categories_container_other_categories_container_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../components/other-categories-container/other-categories-container.component */
    "./src/app/components/other-categories-container/other-categories-container.component.ts");
    /* harmony import */
    ...
    function MainNavComponent_button_11_Template(rf, ctx) {
      if (rf & 1) {
        var _r28 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 4);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MainNavComponent_button_11_Template_button_click_0_listener($event) {
    ...
    MainNavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 12,
      consts: [[1, "sidenav-container"], ["fixedInViewport", "", 1, "sidenav", 3, "mode", "opened"], ["drawer", ""], ["type", "button", "aria-label", "Toggle sidenav", "mat-icon-button", "", 3, "click", 4, "ngIf"], ["type", "button", "aria-label", "Toggle sidenav", "mat-icon-button", "", 3, "click"], ["aria-label", "Side nav toggle icon"]],
  ...
  /***/
  function srcAppModelsArticlePreviewTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArticlePreview", function () {
  ...
  /***/
  function srcAppModelsOtherCategoryTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OtherCategory", function () {
      return OtherCategory;
    });

    var OtherCategory = function OtherCategory() {
      _classCallCheck(this, OtherCategory);
    };
    /***/
  ...
  /***/
  function srcAppServicesOtherCategoriesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OtherCategoriesService", function () {
      return OtherCategoriesService;
    });
    /* harmony import */
    ...
    var OtherCategoriesService =
    /*#__PURE__*/
    function () {
      function OtherCategoriesService(http) {
        _classCallCheck(this, OtherCategoriesService);

        this.http = http;
        this.articlesUrl = "/api/articles/journals";
      }

      _createClass(OtherCategoriesService, [{
        key: "getCategories",
        value: function getCategories() {
          return this.http.get(this.articlesUrl);
        }
    ...
    OtherCategoriesService.ɵfac = function OtherCategoriesService_Factory(t) {
      return new (t || OtherCategoriesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    OtherCategoriesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: OtherCategoriesService,
      factory: OtherCategoriesService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OtherCategoriesService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Major_Paranoia\Documents\menter\klubkacheli\angular-menterblog\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
